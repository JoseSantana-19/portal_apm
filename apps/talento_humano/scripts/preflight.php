...
try{$smtp=Config::smtp();$add('Configuración SMTP',true,$smtp['enabled']?'habilitada con cifrado y certificado validado':'deshabilitada; solo constancia documental');}catch(Throwable $e){$add('Configuración SMTP',false,$e->getMessage());}
