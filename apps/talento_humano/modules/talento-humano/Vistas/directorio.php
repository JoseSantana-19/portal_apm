                ...
                <section class="hero">
                    <div>
                        ...
                        <div class="hero-actions">
                            ...
                            <a href="<?= BASE_URL ?>/talento-humano/empleado/exportar"
                        ...
                        <table id="employeeTable">
                            ...
                            ?>
                                <tr class="table-row" style="animation-delay:<?= $i * 0.04 ?>s"
                                    ...
                                    <td class="action-cell" style="white-space:nowrap; display:flex; align-items:center; gap:5px; padding:10px 8px;">
                                        ...
                                        <a href="<?= BASE_URL ?>/talento-humano/accion-personal?id=<?= $id ?>&cedula=<?= urlencode($cedula) ?>"
                                           ...
                                           style="padding:7px 11px; font-size:.82rem; border-radius:10px; display:inline-flex; align-items:center; gap:5px;">
                                            <i class="bi bi-file-earmark-text" style="font-size:1rem;"></i>
                                            <span style="font-size:.78rem;">Acción</span>
                                        </a>
                                        <!-- 2: Historial laboral -->
                                        <a href="<?= BASE_URL ?>/talento-humano/reporte?empleado_id=<?= $id ?>"
                                           title="Ver historial laboral"
                                           style="width:34px;height:34px;border-radius:10px;border:1px solid rgba(14,116,144,.35);background:#f0fbff;color:#0891b2;display:inline-flex;align-items:center;justify-content:center;font-size:1.05rem;text-decoration:none;transition:background .2s;"
                                           onmouseover="this.style.background='#ccf0ff'" onmouseout="this.style.background='#f0fbff'">
                                            <i class="bi bi-clock-history"></i>
                                        </a>
                                        <!-- 3: Editar expediente -->
                                        <a href="<?= BASE_URL ?>/talento-humano/empleado/editar?id=<?= $id ?>"
                                           title="Editar expediente"
                                           style="width:34px;height:34px;border-radius:10px;border:1px solid rgba(99,102,241,.35);background:#f5f3ff;color:#4f46e5;display:inline-flex;align-items:center;justify-content:center;font-size:1.05rem;text-decoration:none;transition:background .2s;"
                                        ...
                                        <a href="<?= BASE_URL ?>/talento-humano/empleado/imprimir-ficha?id=<?= $id ?>"
                                           ...
                                           target="_blank"
                                           style="width:34px;height:34px;border-radius:10px;border:1px solid rgba(14,116,144,.35);background:#f0fdf9;color:#059669;display:inline-flex;align-items:center;justify-content:center;font-size:1.05rem;text-decoration:none;transition:background .2s;"
                                        ...
                                        <a href="<?= BASE_URL ?>/talento-humano/empleado/borrar?id=<?= $id ?>"
                                           ...
                                           style="width:34px;height:34px;border-radius:10px;border:1px solid rgba(220,38,38,.35);background:#fff1f2;color:#dc2626;display:inline-flex;align-items:center;justify-content:center;font-size:1.05rem;text-decoration:none;transition:background .2s;"
