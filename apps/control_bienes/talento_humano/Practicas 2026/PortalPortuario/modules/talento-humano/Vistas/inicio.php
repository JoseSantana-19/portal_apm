...
$activos   = count(array_filter($empleados ?? [], fn($e) => ($e['estado_funcionario'] ?? $e['estado'] ?? '') === 'Activo'));
$permisos  = count(array_filter($empleados ?? [], fn($e) => ($e['estado_funcionario'] ?? $e['estado'] ?? '') === 'Permiso'));
$inactivos = count(array_filter($empleados ?? [], fn($e) => ($e['estado_funcionario'] ?? $e['estado'] ?? '') === 'Inactivo'));
